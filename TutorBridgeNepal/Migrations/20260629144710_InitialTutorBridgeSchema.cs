...
{
    /// <inheritdoc />
    public partial class InitialTutorBridgeSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TutorAvailabilitySlots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TutorAvailabilitySlots_TutorProfiles_TutorProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TutorProfileId = table.Column<int>(type: "int", nullable: false),
                    TutorAvailabilitySlotId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_TutorAvailabilitySlots_TutorAvailabilitySlotId",
                        column: x => x.TutorAvailabilitySlotId,
                        principalTable: "TutorAvailabilitySlots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TutorAvailabilitySlots_TutorProfileId_StartTime_EndTime",
                table: "TutorAvailabilitySlots",
                columns: new[] { "TutorProfileId", "StartTime", "EndTime" });
